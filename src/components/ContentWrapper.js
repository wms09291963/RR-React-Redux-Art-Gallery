...
function ContentWrapper() {
  ...
  return (
    <div className={`ContentWrapper ${mode}`} style={{ backgroundColor: 'white' }}>
      ...
      <p>Etiam a diam imperdiet, malesuada mi eu, vestibulum erat. Cras bibendum nec lectus vitae vestibulum. Vestibulum eros quam, tempor non rutrum ac, tempor mattis eros. Nulla nec laoreet leo. Vestibulum ut bibendum erat. Integer id quam tincidunt, congue ex ac, dictum lectus. Nam euismod ipsum in erat vulputate ullamcorper. Nam id egestas magna. Mauris eu nunc ac libero feugiat consectetur. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>

      <p>Maecenas id ex in nibh venenatis elementum posuere ut risus. Ut fringilla lectus ultricies, pulvinar orci sit amet, hendrerit justo. Donec quis consequat quam. Nulla et tincidunt tortor. Duis sit amet sem vel sapien posuere</p>
        </div>
  )}
